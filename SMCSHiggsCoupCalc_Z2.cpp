...
int main(int argc, char* argv[])
{
    ...
    while(input)
    {
        ...
        if (goodTN && mHH > sqrt(Mh12)/2.0) {
            ...
            dkappau = SMCS::dKappahu_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MU2,MU2);
            dkappad = SMCS::dKappahd_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MD2,MD2);
            dkappac = SMCS::dKappahc_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MC2,MC2);
            dkappas = SMCS::dKappahs_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MS2,MS2);
            dkappat = SMCS::dKappaht_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MT2,pow(Mh1+MT+10,2));
            dkappab = SMCS::dKappahb_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MB2,MB2);
            dkappaele = SMCS::dKappahele_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,ME2,ME2);
            dkappamuon = SMCS::dKappahmuon_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MM2,MM2);
            dkappatau = SMCS::dKappahtau_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,ML2,ML2);
            dkappaW = SMCS::dKappahW_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,30*30,30*30);
            dkappaZ = SMCS::dKappahZ_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,30*30,30*30);
            dkappag = SMCS::dghg_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,0.01,0.01);
            dkappaga = SMCS::dghga_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,0.01,0.01);
            dkappaZga = SMCS::dgZga_Z2(mHH*mHH,mHA*mHA,d2,del2,Mh12,MZ2,0.01);
            ...
            S = Re(STU::SinSMCS_Z2(mHH*mHH,mHA*mHA,d2,del2));
            T = Re(STU::TinSMCS_Z2(mHH*mHH,mHA*mHA,d2,del2));
            U = Re(STU::UinSMCS_Z2(mHH*mHH,mHA*mHA,d2,del2));
